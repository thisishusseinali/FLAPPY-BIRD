...
# Function to check for collisions with pipes or boundaries
...
# Load and scale background and floor images
...
bird_downflap = pygame.transform.scale2x(pygame.image.load('./assets/images/bluebird-midflap.png').convert_alpha())
bird_midflap = pygame.transform.scale2x(pygame.image.load('./assets/images/bluebird-midflap.png').convert_alpha())
bird_upflap = pygame.transform.scale2x(pygame.image.load('./assets/images/bluebird-midflap.png').convert_alpha())
